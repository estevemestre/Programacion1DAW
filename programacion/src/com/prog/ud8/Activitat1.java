...
public class Activitat1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(nomComplet +" té " +nomComplet.length() + " caracteres");
		...
		System.out.println("El teu nom en mayúcules "+nomComplet.toUpperCase());
			...
			if (nom.length() >= 2) {
				...
				System.out.println("Els 2 ultims caracters son : "+nom.substring(nom.length()-2));  //mostra els 2 últims caràcters
